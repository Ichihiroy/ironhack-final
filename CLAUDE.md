...
**Docs discipline.** Every non-obvious decision has a numbered ADR in `docs/adr/` (0001–0007) and a summary in `docs/architecture.md`; README has a rubric→file map. If you change a decision, update its ADR and the rubric map, not just the code.
